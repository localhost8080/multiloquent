...
<head>
    ...
    <meta name="verify-v1" content="ut0dP2qKKQjpEIxdJFQTaUfdb8nGSjLCSkCnQ8rKv94=">
    <meta name="msvalidate.01" content="206E382A6268FE587FB7B48CF06E4FFA">
    <meta name="google-site-verification" content="yZpmS1cltNJOXASoNl5A4ujl6rVhkP18k_7XttrAerY">
    <meta property="fb:admins" content="618534458" />
    <meta name="geo.region" content="GB-SAY">
    <meta name="geo.placename" content="Ayr">
    <meta name="geo.position" content="55.46;-4.63">
    <meta name="ICBM" content="55.46, -4.63">
    ...
    <meta property="og:image" content="<?php echo  get_template_directory_uri()  ; ?>/images/icons/logo-large.png">
    ...
    if (function_exists('ghpseo_output')){
		...
		if ( is_home() ) {
			...
			echo get_bloginfo('name') . ' - ' . get_the_time('Y');} elseif ( is_search() ) {
...
?></title>
    ...
    <link rel="alternate" type="application/rss+xml" title="<?php bloginfo('name'); ?> RSS Feed" href="http://jonathansblog.co.uk/feed">
