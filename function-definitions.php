...
function multiloquent_bootstrap_comments($comment, $args, $depth)
{
    // Comment Layout
...
<?php
    ...
    edit_comment_link(__('Edit', 'multiloquent'), '<span class="edit-comment btn btn-sm btn-info"><i class="glyphicon-white glyphicon-pencil"></i>', '</span>');
...
function multiloquent_list_pings($comment, $args, $depth)
{
    $GLOBALS['comment'] = $comment;
    echo '<li><i class="icon icon-share-alt"></i>' . get_comment_author_link();
}
