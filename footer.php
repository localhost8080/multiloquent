	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-6 col-md-6 col-lg-6 no-bullets">
				...
				<ul>
					<li><a href="/privacy-policy"><span class="fa fa-comment-o fa-fw"></span> Privacy Policy</a></li>
					<li><a href="/about"><span class="fa fa-pencil-square-o fa-fw"></span> About</a></li>		
					<?php
						global $user_ID;
						...
						<?php } ?>
					<li><a href="/about"><span class="fa fa-clock-o fa-fw"></span> &#169; 2008 - <?php echo date('Y') .' '. get_bloginfo('name'); ?></a></li>
			...
			<div class="col-sm-6 col-md-6 col-lg-6 no-bullets">
				...
				<?php // sidebar 10 for some things in footer
