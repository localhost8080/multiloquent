...
<section class="well">
    ...
    if ($user_ID && current_user_can('update_core')) {
        ?>
							<li><a href="/wp-admin"><span class="fa fa-user fa-fw"></span>
							Dashboard</a></li>
						<?php }else{ ?>
							<li><a href="/wp-login.php"><span class="fa fa-lock fa-fw"></span>
							Login</a></li>
						<?php } ?>
					...
					<li><a href="/about"><span class="fa fa-gamepad fa-fw"></span><span
							style="font-size: 12px;">This website is most definitely not best
								viewed in Netscape</span></a></li>
				</ul>
			</div>
			<div class="span6">
