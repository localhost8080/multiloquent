...
add_action('after_setup_theme', multiloquent_register($wp_customize));
...
function multiloquent_register($wp_customize) {
    ...
    add_action('customize_register', $multiloquent->multiloquent_customize_register($wp_customize));
    ...
    // add_filter('the_tags', $multiloquent->multiloquent_add_class_the_tags, 10, 1);
    ...
    $multiloquent->multiloquent_menu();
